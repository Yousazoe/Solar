...
public:
    ...
    /// specializations of the hw::Utf<> template, and allow
...
public:
    ...
    /// of hw::Utf<>, it is defined for convenience (it is used by
...
///
/// hw::Utf is a low-level, generic interface for counting, iterating,
...
///
/// hw::Utf<X> functions are all static, these classes are not meant to
/// be instantiated. All the functions are template, so that you
/// can use any character / string type for a given encoding.
///
/// It has 3 specializations:
/// \li hw::Utf<8> (typedef'd to hw::Utf8)
/// \li hw::Utf<16> (typedef'd to hw::Utf16)
/// \li hw::Utf<32> (typedef'd to hw::Utf32)
///
////////////////////////////////////////////////////////////
