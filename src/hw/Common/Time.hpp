...
private:
    ...
    /// use hw::seconds, hw::milliseconds or hw::microseconds instead.
    ///
...
/// \ingroup system
///
/// hw::Time encapsulates a time value in a flexible way.
...
/// Usage example:
/// \code
/// hw::Time t1 = hw::seconds(0.1f);
/// Int32 milli = t1.asMilliseconds(); // 100
///
/// hw::Time t2 = hw::milliseconds(30);
/// Int64 micro = t2.asMicroseconds(); // 30000
///
/// hw::Time t3 = hw::microseconds(-800000);
/// float sec = t3.asSeconds(); // -0.8
/// \endcode
///
/// \code
/// void update(hw::Time elapsed)
/// {
///    position += speed * elapsed.asSeconds();
/// }
///
/// update(hw::milliseconds(100));
/// \endcode
///
/// \see hw::Clock
///
