...
/// setup windows (hw::Window) at creation time.
///
...
///
/// hw::VideoMode provides a static function for retrieving
...
///
/// Additionally, hw::VideoMode provides a static function
...
/// std::vector<hw::VideoMode> modes = hw::VideoMode::getFullscreenModes();
/// for (std::size_t i = 0; i < modes.size(); ++i)
/// {
///     hw::VideoMode mode = modes[i];
///     std::cout << "Mode #" << i << ": "
...
/// hw::VideoMode desktop = hw::VideoMode::getDesktopMode();
/// window.create(hw::VideoMode(1024, 768, desktop.bitsPerPixel), "SFML window");
/// \endcode
///
////////////////////////////////////////////////////////////
