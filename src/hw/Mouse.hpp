...
/// \ingroup window
///
/// hw::Mouse provides an interface to the state of the
...
/// and MouseButtonReleased events, hw::Mouse can retrieve the
...
/// Usage example:
/// \code
/// if (hw::Mouse::isButtonPressed(hw::Mouse::Left))
/// {
///     // left click...
/// }
///
/// // get global mouse position
/// hw::Vector2i position = hw::Mouse::getPosition();
///
/// // set mouse position relative to a window
/// hw::Mouse::setPosition(hw::Vector2i(100, 200), window);
/// \endcode
///
/// \see hw::Joystick, hw::Keyboard, hw::Touch
///
////////////////////////////////////////////////////////////
