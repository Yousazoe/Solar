...
/// \ingroup window
///
/// hw::Keyboard provides an interface to the state of the
...
/// hw::Keyboard can retrieve the state of a key at any time
...
/// Usage example:
/// \code
/// if (hw::Keyboard::isKeyPressed(hw::Keyboard::Left))
/// {
///     // move left...
/// }
/// else if (hw::Keyboard::isKeyPressed(hw::Keyboard::Right))
/// {
///     // move right...
/// }
/// else if (hw::Keyboard::isKeyPressed(hw::Keyboard::Escape))
/// {
///     // quit...
/// }
/// \endcode
///
/// \see hw::Joystick, hw::Mouse, hw::Touch
///
////////////////////////////////////////////////////////////
