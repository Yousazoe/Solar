...
namespace
{
    ...
    hw::priv::WindowImplWin32* fullscreenWindow = NULL;
    ...
    void setProcessDpiAware()
    {
        ...
        if (shCoreDll)
        {
            ...
            if (SetProcessDpiAwarenessFunc)
            {
                ...
                {
                    //hw::err() << "Failed to set process DPI awareness" << std::endl;
                }
                else
                {
...
////////////////////////////////////////////////////////////
Vec2i WindowImplWin32::getPosition() const
{
    RECT rect;
...
////////////////////////////////////////////////////////////
void WindowImplWin32::setPosition(const Vec2i& position)
{
...
////////////////////////////////////////////////////////////
Vec2u WindowImplWin32::getSize() const
{
    RECT rect;
...
////////////////////////////////////////////////////////////
void WindowImplWin32::setSize(const Vec2u& size)
{
...
void WindowImplWin32::processEvent(Uint32 message, Uint32 wParam, Uint32 lParam)
{
	processEvent((UINT)message, (WPARAM)wParam, (LPARAM)lParam);
}
            ...
            if (m_keyRepeatEnabled || ((lParam & (1 << 30)) == 0))
            {
                ...
                else
                {
                    ...
                    if ((character >= 0xDC00) && (character <= 0xDFFF))
                    {
                        ...
                        hw::Utf16::toUtf32(utf16, utf16 + 2, &character);
                        m_surrogate = 0;
                    }
