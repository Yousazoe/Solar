...
////////////////////////////////////////////////////////////
Vec2i InputImpl::getMousePosition()
{
    POINT point;
    GetCursorPos(&point);
...
////////////////////////////////////////////////////////////
Vec2i InputImpl::getMousePosition(const Window& relativeTo)
{
...
////////////////////////////////////////////////////////////
void InputImpl::setMousePosition(const Vec2i& position)
{
...
////////////////////////////////////////////////////////////
void InputImpl::setMousePosition(const Vec2i& position, const Window& relativeTo)
{
    WindowHandle handle = relativeTo.getSystemHandle();
    if (handle)
    {
...
////////////////////////////////////////////////////////////
Vec2i InputImpl::getTouchPosition(unsigned int /*finger*/)
{
    // Not applicable
    return Vec2i();
}
...
////////////////////////////////////////////////////////////
Vec2i InputImpl::getTouchPosition(unsigned int /*finger*/, const Window& /*relativeTo*/)
{
    // Not applicable
    return Vec2i();
}
