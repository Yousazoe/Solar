...
/// \ingroup window
///
/// hw::Event holds all the informations about a system event
/// that just happened. Events are retrieved using the
/// hw::Window::pollEvent and hw::Window::waitEvent functions.
///
/// A hw::Event instance contains the type of the event
...
///     if ((event.type == hw::Event::KeyPressed) && (event.key.code == hw::Keyboard::Escape))
///         window.close();
///
///     // The window was resized
///     if (event.type == hw::Event::Resized)
